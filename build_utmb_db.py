...
# --- Configuración ---
CSV_PATH = r"C:\path\to\utmb_puerto_vallarta_24.csv"   # dirección del archivo plano
...
def load_and_clean(csv_path: str) -> pd.DataFrame:
    ...
    # se tratan como personas dististas ya que, para este caso particular,
    # la misma persona no puede correr dos carreras el mismo día, por ello
    # se tratan como corredores separados -marcando cada uno con un last_name 
    # sintético único por fila- en vez de fusionarlos bajo la misma llave natural.
